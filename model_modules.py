...
class EncoderBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=4, stride=1, padding=1, dilation=1, groups=1, bias=False,
...
class DecoderBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=4, stride=1, padding=1, bias=False,
...
class Generator(nn.Module):
    def __init__(self, in_channels=3, out_channels=3, bias = False, dropout_prob=0.5, norm = 'batch'):
        ...
        self.decoder2 = DecoderBlock(2304, 1536, bias=bias, norm=norm, dropout_prob=dropout_prob)
        self.decoder3 = DecoderBlock(2560, 1536, bias=bias, norm=norm, dropout_prob=dropout_prob)
        self.decoder4 = DecoderBlock(2304, 1536, bias=bias, norm=norm, dropout_prob=dropout_prob)
